...
def main():
    ...
    for match_idx, (t1_name, t2_name) in enumerate(RO32_MATCHUPS, 1):
    ...
    print("Calculant probabilitats de guanyar el mundial (1000 iteracions des de Setzens)...")
    try:
        ...
        winners = []
        # Utilitzem RO32_MATCHUPS definit a l'inici del fitxer com a punt de partida
        for i in range(100000): # 100.000 iteracions d'alta precisió per la nit
            champion = simulate_bracket(RO32_MATCHUPS)
            if champion:
    ...
    output_path = PROJECT_ROOT / "Prediccions_Setzens_CAT_WC2026.pdf"
