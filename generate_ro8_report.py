...
RO8_MATCHUPS = [
    # Quarts de final - Mundial 2026 (9-11 juliol 2026)
    ("France", "Morocco"),
    ("Spain", "Belgium"),
    ("Norway", "England"),
...
def main():
    print("Generant Premium PDF de Quarts de Final en català...")
    ...
    for match_idx, (t1_name, t2_name) in enumerate(RO8_MATCHUPS, 1):
        ...
        pdf.cell(0, 8, f"QUART DE FINAL {match_idx}: {t1_name} vs {t2_name}", fill=True, new_x=XPos.LMARGIN, new_y=YPos.NEXT, align="C")
    ...
    print("Calculant probabilitats de guanyar el mundial des de Quarts...")
    try:
        ...
        winners = []
        # Utilitzem RO8_MATCHUPS definit a l'inici del fitxer com a punt de partida
        for i in range(100000): # 100.000 iteracions d'alta precisio per la nit
            champion = simulate_bracket(RO8_MATCHUPS)
            if champion:
    ...
    output_path = PROJECT_ROOT / "Prediccions_Quarts_CAT_WC2026.pdf"
